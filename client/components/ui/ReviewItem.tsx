...
export default function ReviewItem(props : ReviewItemType) {
  ...
  return (
    <View key={props._id} className='h-[100px] w-[100%] flex flex-row gap-4 pr-3 mb-10 bg-white px-3 py-2 rounded-lg' 
    style={{
      shadowColor: "#000", 
      elevation: 15, 
      shadowOffset: {
        ...
        <View className='flex-1 flex flex-col gap-2'>
          ...
          <View className='flex flex-row justify-between '>
              <View className='flex flex-col gap-1'>
                <Text className='text-[20px] font-TenorSans-Regular'>{props.review_user.email}</Text>
                <Text className='text-[14px] font-TenorSans-Regular text-[#888]'>DD/MM/YYYY</Text>
              </View>
